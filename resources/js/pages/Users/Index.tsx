...
export default function Index({ users, branches, roles }: any) {
        ...
        dark:bg-primary-foreground p-4 rounded-lg"
            >
                            ...
                            {filteredUsers.length === 0 ? (
                                ...
                                filteredUsers.map(({ id, name, email, email_verified_at, user_status, created_at, branch, roles }: any) => (
                                    <TableRow key={id}>
                                        ...
                                        {/* --- REAL DATA REPLACEMENT START --- */}
                                        <TableCell>
                                            {/* Check if branch exists, otherwise show placeholder/empty */}
                                            {branch ? (
                ...
                <div className="mt-4 flex justify-between items-center">
                    <h2>Showing Results: <strong>{users?.total || 0}</strong> </h2>
