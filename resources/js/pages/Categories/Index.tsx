...
import { Plus, Pencil, Trash2, Search, Folder, Loader2 } from 'lucide-react';
...
export default function Index({ categories, filters }: Props) {
    ...
    const executeDeleteAll = () => {
        ...
        router.post("/categories/delete-all", {}, {
            onSuccess: () => {
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        {isSystemAdmin && (
                            ...
                            >
                                <Trash2 className="mr-2 h-4 w-4" /> Delete All Categories
                            </Button>
                        )}
                        {!isEmployee && (
                ...
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        <DialogTitle className="flex items-center gap-2 text-red-600 font-bold">
                            <Trash2 className="h-5 w-5" /> Confirm Deletion of All Categories
                        </DialogTitle>
                    </DialogHeader>
