...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['restrict.employee'])->group(function () {
        ...
        Route::post('products/delist-all-branch', [\App\Http\Controllers\ProductController::class, 'delistAllBranchProducts'])->name('products.delist-all-branch');
    ...
    Route::post('/google-sheets/match-quantity', [\App\Http\Controllers\GoogleSheetsSyncController::class, 'matchQuantity'])->name('google-sheets.match-quantity');
